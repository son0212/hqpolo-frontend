...
import imgDemoProduct01 from "../../images/list-demo-product/polo-xanh-than01.jpg";
import imgDemoProduct02 from "../../images/list-demo-product/polo-xanh-than02.jpg";
import imgDemoProduct03 from "../../images/list-demo-product/polo-xanh-than03.jpg";
import imgDemoProduct04 from "../../images/list-demo-product/polo-xanh-than04.jpg";
import imgDemoProduct05 from "../../images/list-demo-product/polo-xanh-than05.jpg";
import tableSize from "../../images/list-img-product/table-polo.jpg";
			...
			<Container>
				<Row>
					...
					<div className="div-demo-product">
						...
						<img src={imgDemoProduct01} className="img-demo" alt="img-01" title="xanh than 01" />
						<img src={imgDemoProduct02} className="img-demo" alt="img-02" title="xanh than 02" />
						<img src={imgDemoProduct03} className="img-demo" alt="img-03" title="xanh than 03" />
						<img src={imgDemoProduct04} className="img-demo" alt="img-04" title="xanh than 04" />
						<img src={imgDemoProduct05} className="img-demo" alt="tutorial-choose-size" title="tutorial-choose-size" />
						<img src={tableSize} className="img-demo" alt="img-05" title="xanh than 05" />
					</div>
