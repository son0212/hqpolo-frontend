...
import logoHQPOLO from "../images/logoHQPOLO-end-page.jpg"; 

export default class InforEndPage extends React.Component{
	render(){
		return(
			<React.Fragment>
				<Box>
		      ...
		      <Container>
		        <Row>
			        <div className="founding">
								<img src={logoHQPOLO} alt="Trang chủ hqpolo.com" />
